...
pub(crate) fn sort_key_from_str(s: &str) -> Option<crate::actions::SortKey>
{
    ...
    match low.as_str()
    {
        ...
        "mtime" | "modified" | "time" | "date" | "t" =>
        {
            Some(crate::actions::SortKey::MTime)
        }
        "created" | "ctime" | "birth" | "c" =>
        {
            Some(crate::actions::SortKey::CTime)
        }
        _ => None,
    }
}
...
#[inline]
pub(crate) fn info_mode_to_str(m: crate::app::InfoMode)
-> Option<&'static str>
{
    match m
    {
...
pub(crate) fn display_mode_from_str(s: &str)
-> Option<crate::app::DisplayMode>
{
    let low = s.to_ascii_lowercase();
    match low.as_str()
    {
