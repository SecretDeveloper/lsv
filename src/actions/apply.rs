...
)
{
    ...
    match fx.confirm
    {
        ...
        {
            crate::trace::log(
                "[apply] confirm=delete_selected -> \
                 request_delete_selected(all)",
            );
    ...
    match fx.clipboard
    {
        crate::actions::effects::ClipboardCommand::CopyArm =>
        {
            app.copy_selection()
        }
        crate::actions::effects::ClipboardCommand::MoveArm =>
        {
            app.move_selection()
        }
        crate::actions::effects::ClipboardCommand::Paste =>
        {
            app.paste_clipboard()
        }
        crate::actions::effects::ClipboardCommand::Clear =>
        {
            app.clear_clipboard()
        }
